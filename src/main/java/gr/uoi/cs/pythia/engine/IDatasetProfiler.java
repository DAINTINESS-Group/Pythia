...
public interface IDatasetProfiler {
  ...
  /**
   * Declares paramaters for dominance highlight pattern identification. This method is required
   ...
   * @throws IOException
   */
  DatasetProfile computeProfileOfDataset(DatasetProfilerParameters execParameters) 
		  throws IOException;

    /**
     * Generates a report with all the generated analysis resutls in a file of a specific format, 
