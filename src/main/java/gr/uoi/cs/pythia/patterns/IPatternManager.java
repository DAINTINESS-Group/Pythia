 ...
 * dataset is then passed by the respective highlight identification algorithms and 
 * the generated results are saved in result objects accordingly.
 * 
 * 
 * TODO IOException will probably be removed since reporting will be performed
