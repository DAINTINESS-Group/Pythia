...
@RunWith(Suite.class)
@Suite.SuiteClasses({
     AnalysisSelectionPanelTest.class,
        AnalysisTabsPanelTest.class,
        ApplicationNavigationPanelTest.class,
        DatasetInputPanelTest.class,
        MainWindowTest.class,
})
public class AllButtonPanelTest
{
    @AfterClass
