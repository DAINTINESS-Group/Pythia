...
public class DivisiveClusteringPerformerTests {
	...
	public void init() {
		...
		clusteringPerformer = new ClusteringPerformerFactory().createClusteringPerformer(
				new ClusteringParameters(ClusteringType.DIVISIVE, 4, Arrays.asList("manufacturer", "model", "fuelType")), datasetProfile);
	}
	...
	public void testPerformClustering() {
		...
		assertEquals(ClusteringType.DIVISIVE, realType);
	}
}
