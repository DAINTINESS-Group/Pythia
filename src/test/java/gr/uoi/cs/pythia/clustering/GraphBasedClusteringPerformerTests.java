...
public class GraphBasedClusteringPerformerTests {
	...
	public void init() {
		...
		clusteringPerformer = new ClusteringPerformerFactory().createClusteringPerformer(
				new ClusteringParameters(ClusteringType.GRAPH_BASED, 4, Arrays.asList("manufacturer", "model", "fuelType")), datasetProfile);
	}
	...
	public void testPerformClustering() {
		...
		assertEquals(ClusteringType.GRAPH_BASED, realType);
	}
}
